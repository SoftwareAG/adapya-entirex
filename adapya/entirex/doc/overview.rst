...
*adapya-entirex* is a library for persistent messaging using the Advanced
Communication Interface (ACI) of the EntireX Broker from Software AG.
...
-   Information of the `Software AG EntireX Product
    <https://resources.softwareag.com/application-modernization/webmethods-entirex>`_

-   `EntireX documentation
    <http://techcommunity.softwareag.com/ecosystem/documentation/webmethods/entirex/entirex_vers.htm>`_
