...
"""etbcinf8.py contains selected Command Info Services classes Info_*
     ...
     Info_broker, Info_conversation, Info_clientserver, Info_psf
     Info_service

   Generally the Info_* classes are imported from etbcinf.py
   But the classes mentioned above have changed in Broker V10.
...
class Info_broker(Datamap):
    def __init__(self, **kw):
        ...
        Uint4('CPU_used_seconds'),
        Uint4('CPU_used_micro'),
        Uint4('CPU_used_pecent'),
        )
...
class Info_conversation(Datamap):
    def __init__(self, **kw):
        ...
        Uint1('roaming'),                   # 10 Server: Roaming 0 or 1
        )
...
class Info_clientserver(Datamap):
    def __init__(self,  clientserver, **kw):
        ...
        String('unused10',3,opt=T_NONE),    # 10 Alignment
        )
...
class Info_psf(Datamap):
    def __init__(self, **kw):
        ...
        Uint4('postponeDelay'),             #
        String('back2accepted',32),         #    Unit of work postponed to ACCEPTED
